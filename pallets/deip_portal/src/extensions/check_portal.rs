    ...
    T::Call: Dispatchable<Info=DispatchInfo> + Send + Sync
{
    ...
    fn post_dispatch(
        ...
        crate::PortalTag::<T>::append(n, portal_id, idx);
        // use sp_core::hashing::twox_128;
        // use frame_system::Phase;
        // let mut key = twox_128(b"System").to_vec();
        // key.extend(twox_128(b"ExecutionPhase").to_vec());
        // let maybe_phase = frame_support::storage::unhashed::get::<Phase>(key.as_slice());
        // if let Some(Phase::ApplyExtrinsic(i)) = maybe_phase {
        //     
        // }
		Ok(())
	}
