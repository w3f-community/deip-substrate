...
use node_template_runtime::{opaque::Block, AccountId, AssetBalance, AssetId, Balance, Index, Moment};
...
where
    ...
    C::Api: deip_rpc::DeipStorageRuntimeApi<Block, AccountId, Moment, AssetId, AssetBalance>,
